...
//The next layer is the data model layer, which will contain tuples that model how the data is stored in the data helper layer pretty closely
...
//data helper for persisting data
...
//The final layer is the bridge layer, which converts the data from the business logic layer into the data-access layer. The bridge layer is the layer that separates our business logic from the data access logic
struct  TeamBridge  {
