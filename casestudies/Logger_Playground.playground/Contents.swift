import Cocoa
//logger profiles to which will either log null or log something , each profile will be unique
//we define loglevels as well
...
//This type will keep track of which logger profiles are assigned to the various log levels.
protocol  Logger  {
...
extension Logger {
    //loglevel contains the log profile
